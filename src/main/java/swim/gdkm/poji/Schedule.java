...
public class Schedule {
	...
	public int getSc_cl_id() {
		return sc_cl_id;
	}

	public void setSc_cl_id(int sc_cl_id) {
		this.sc_cl_id = sc_cl_id;
	}
	...
	public String toString() {
		return "Schedule [sc_id=" + sc_id + ", sc_name=" + sc_name + ", sc_start=" + sc_start + ", sc_end=" + sc_end
				+ ", sc_week=" + sc_week + ", sc_time=" + sc_time + ", sc_classroom=" + sc_cl_id + ", sc_user_id="
				+ sc_user_id + "]";
	}
